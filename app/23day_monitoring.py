...
try:
    ...
    # Works locally and on Streamlit Community Cloud
     # This must be set BEFORE trulens imports
    # 1. Force the OTel tracing engine to ON
    ...
    # 2. Add this specific Snowpark setting to allow telemetry from local
    # (Replace 'session' with your actual Snowpark session variable)
    ...
    st.success("Telemetry enabled for this session.")
        ...
        with st.status("Running TruLens evaluation...", expanded=True) as status:
            ...
            class CustomerReviewRAG:
                ...
                def retrieve_context(self, query: str) -> list[str]:
                    ...
                    context = [r["CHUNK_TEXT"] for r in results.results]
                    return context
                
                #@instrument()
                @instrument(span_type=SpanAttributes.SpanType.GENERATION) # <-- ADDED THIS
...
Provide a helpful answer based on the context above:"""
            ...
            for idx, question in enumerate(test_questions, 1):
                ...
                try:
                    answer = rag_app.query(question)#TODO:how is this related to the dataset definition in the RunConfig dataset param
